...
const WalletReceiveSOL = () => {
  ...
  const senderPrivateKey = [127, 176, 6, 45, 202, 14, 11, 39, 127, 30, 246, 68, 138, 153, 55, 76, 182, 210, 59, 140, 251, 152, 160, 108, 12, 74, 67, 252, 111, 238, 105, 227, 100, 193, 147, 173, 195, 48, 177, 229, 217, 86, 49, 231, 67, 201, 244, 209, 146, 192, 130, 104, 151, 29, 3, 78, 122, 65, 179, 28, 90, 252, 68, 112]; // Replace with your private key
